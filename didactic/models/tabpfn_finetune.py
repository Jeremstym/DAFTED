...
import numpy as np
import sklearn.datasets # type: ignore[import-untyped]
import torch
...
from tabpfn.finetune_utils import clone_model_for_evaluation # type: ignore[import-untyped]
from tabpfn.utils import meta_dataset_collator # type: ignore[import-untyped]
