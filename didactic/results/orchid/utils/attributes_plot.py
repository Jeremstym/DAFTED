...
from typing import Dict, Hashable, Iterator, Optional, Sequence, Tuple, Union, cast
...
class AttributesPlots(ResultsProcessor):
    ...
    def process_result(self, result: View | Patient) -> None:
    ...
    def _extract_attributes_data(self, result: View | Patient) -> pd.DataFrame:
        ...
        return build_attributes_dataframe(
            attrs_data,  # type: ignore[arg-type]
    ...
    @abstractmethod
    def _extract_attributes_from_result(self, result: View | Patient, item_tag: str) -> Dict[str, np.ndarray]:
