...
from dafted.tasks.cardiac_sequence_attrs_pca import CardiacSequenceAttributesPCA  # noqa
...
class TimeSeriesAttributesMetrics(Metrics):
    ...
    ProcessingOutput = Dict[str, np.ndarray]
    ...
    def process_result(self, result: View) -> Tuple[View.Id, "ProcessingOutput"]: # type: ignore[override]
