...
from dafted.tasks.cardiac_sequence_attrs_ae import CardiacSequenceAttributesAutoencoder
from dafted.tasks.cardiac_sequence_attrs_pca import CardiacSequenceAttributesPCA
...
def interactive_cardiac_sequence_attrs_interpolation(
    ...
    def _update_view(src_patient: Patient.Id, dest_patient: Patient.Id) -> None: # type: ignore[valid-type]
    ...
    def _update_src(patient: Patient.Id, view: ViewEnum, attr: TimeSeriesAttribute) -> None: # type: ignore[valid-type]
    ...
    def _update_dest(patient: Patient.Id, view: ViewEnum, attr: TimeSeriesAttribute) -> None: # type: ignore[valid-type]
