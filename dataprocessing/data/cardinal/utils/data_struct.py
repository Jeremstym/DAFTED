...
from dataprocessing.data.cardinal.config import (
    ATTRS_CACHE_FORMAT,
...
from dataprocessing.data.cardinal.utils.attributes import compute_mask_time_series_attributes
...
class Patient:
    ...
    def from_dir(
        ...
        **kwargs,
        ...
        """
        from dataprocessing.data.cardinal.utils.itertools import views_avail_by_patient
